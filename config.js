...
import DipslayImage from './components/DisplayImage';


const config = {
    botName: "AgeDrive Explorer",
    initialMessages: [createChatBotMessage(`Welcome to RideAge Advisor! click the below "Let's Get Started" to continue"`, {
        widget: "startBtn"
    })],
    customComponents: {
